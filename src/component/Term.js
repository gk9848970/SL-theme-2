    ...
    return (
        <div style={{marginTop:'60px'}}>
                ...
                <b><u>Terms & Condition</u></b>
                    <p>    
                        The terms "We" / "Us" / "Our"/”Company” individually and collectively refer to <span style={{fontWeight: '600'}}>{webDetail.institute_name}</span> and the terms "Visitor” ”User” refer to the users.
                    </p>
                    <p>
                    ...
                    <p> 
                        <span style={{fontWeight: '600'}}>USE OF CONTENT </span>
                    </p>
                    <p>
                    ...
                    <p> 
                    <span style={{fontWeight: '600'}}>ACCEPTABLE WEBSITE USE</span>
                    </p>
                    <p>
                        <span style={{fontWeight: '600'}}>A) Security Rules</span>      
                    </p>
                    <p>    
                    ...
                    <p>
                        <span style={{fontWeight: '600'}}>B) General Rule</span>
                    </p>
                    <p>
                    ...
                    <p> 
                        <span style={{fontWeight: '600'}}>INDEMNITY</span>
                    </p>
                    <p>
                    The User unilaterally agree to indemnify and hold harmless, without objection, the Company, its officers, directors, employees and agents from and against any claims, actions and/or demands and/or liabilities and/or losses and/or damages whatsoever arising from or resulting from their use of site35.mycareerlift.com or their breach of the terms .
                    </p>
                    <p>
                        <span style={{fontWeight: '600'}}>LIABILITY</span>
                        </p>
                        <p> 
                        ...
                        <p>
                        <span style={{fontWeight: '600'}}>ISCLAIMER OF CONSEQUENTIAL DAMAGES</span>
                        </p>
                        <p>
